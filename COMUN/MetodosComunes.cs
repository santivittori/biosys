...
namespace COMUN
{
    static public class MetodosComunes
    {
        ...
        public static void EnviarMail(StringBuilder CuerpoMail, string remitente, string email)
        {
            try
            {
                SmtpClient server = new SmtpClient("smtp.gmail.com", 587);
                server.Credentials = new System.Net.NetworkCredential("soportebiosys@gmail.com", "soportebiosys2023");
                ...
                CuerpoMail.AppendLine("Enviado desde " + remitente);
                CuerpoMail.AppendLine("-------------------------------------------------------------------------------");

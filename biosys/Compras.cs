...
namespace biosys
{
    public partial class Compras : Form
    {
        ...
        private void btnRegistrarCompra_Click(object sender, EventArgs e)
        {
            ...
            {
                msgError("  Ingrese al menos un detalle de compra.");
                return;
            }

            // Mostrar cuadro de diálogo de confirmación
            DialogResult result = MessageBox.Show("¿Desea realizar la compra?", "Confirmar Compra", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
